...
<head>
	<meta charset="UTF-8">
	<title>FLEXO Tutorial | Positioning & Filling</title>
	...
	<main id="tutorial-s">
		<div class="container fluid">
			<div class="row wrap block">
				...
				<div class="fl-box fl-sm-12 fl-md-10 fl-lg-8 fl-mg-7 fl-ut-8 fl-md-offset-1 fl-mg-offset-2">
					<div class="fl-box-in">
						<video controls>
							<source src="../video/positioning-filling.mp4" type="video/mp4">
